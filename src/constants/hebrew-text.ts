...
export const HEBREW_TEXT = {
  ...
  event: {
    ...
    noSpotsAvailableMessage: "לא נותרו מקומות פנויים באירוע זה. לא ניתן לאשר אורחים נוספים.",
    ...
    guestCountLowerThanApprovedError: "מספר המקומות לא יכול להיות נמוך ממספר האורחים שכבר אושרו ({count}).",
  },
  profile: {
  ...
  chat: {
    ...
    eventsInMyOwnership: "בקשות לאירועים שלי",
    ...
    allChats: "כל הבקשות",
    futureEventChats: "בקשות לאירועים עתידיים",
    pastEventChats: "בקשות לאירועים שעברו",
    ...
    statusActiveDisplay: "בקשה פעילה",
    statusClosedDisplay: "בקשה שנסגרה",
    chatStatusFilter: "סנן לפי סטטוס בקשה",
  ...
  general: {
    ...
    appDescription: "פלטפורמה המחברת בין זוגות מתחתנים שחסרים להם אורחים לבין אורחים המחפשים מקומות פנויים ברגע האחרון. עזרו לזוגות להשלים את החסר ובואו לשמח חתן וכלה ולהנות מערב מושקע.",
    forCouples: "לזוגות",
    forGuests: "לאורחים",
