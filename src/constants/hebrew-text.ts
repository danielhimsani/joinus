...
export const HEBREW_TEXT = {
  ...
  general: {
    ...
    appDescription: "פלטפורמה המחברת בין זוגות מתחתנים שחסר להם אורחים לבין אורחים המחפשים מקומות פנויים ברגע האחרון. עזרו לזוגות להשלים את החסר ותבואו לשמח חתן וכלה ולהנות מערב מושקע.",
    forCouples: "לזוגות",
    forGuests: "לאורחים",
