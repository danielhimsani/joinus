...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left", // sm:text-left becomes sm:text-right in RTL
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", // sm:justify-end pushes to left in RTL, space-x-2 reverses in RTL
      className
    )}
    {...props}
  />
