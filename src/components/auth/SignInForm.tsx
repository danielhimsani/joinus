      ...
      <CardContent>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3">
             {signInMethod === 'email' && (
                <Button variant="outline" type="button" onClick={() => { setSignInMethod('phone'); resetPhoneAuthFlow(); }} disabled={isLoadingOverall} className="relative">
           ...
           <div className="mt-3 grid grid-cols-2 gap-3">
            ...
            <Button variant="outline" type="button" onClick={handleAppleSignIn} disabled={isLoadingOverall}>
