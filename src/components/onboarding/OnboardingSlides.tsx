...
const slides: SlideContent[] = [
  ...
  },
  {
    ...
    description: "יש לכם מקומות פנויים בחתונה? מתקשים לעמוד בהתחייבות? אל תתנו להם להתבזבז! פרסמו את האירוע שלכם ב-Join us ומצאו אורחים שישמחו לחגוג איתכם ולכסות את העלויות.",
    imageUrl: "/onboarding/slide-2.png",
    imageHint: "wedding couple",
  },
  {
    title: HEBREW_TEXT.general.forGuests,
    description: "מחפשים אירוע להצטרף אליו ברגע האחרון? רוצים לעזור ולשמוח עם חתן וכלה?\n גלו חתונות עם מקומות פנויים, הצטרפו לחגיגה ותהנו מערב בלתי נשכח במחיר משתלם.",
    imageUrl: "/onboarding/slide-3.png",
    imageHint: "wedding guests",
  },
  {
    title: `${HEBREW_TEXT.general.howItWorks} (1/3)`,
    description: "זוגות מפרסמים:\nזוגות עם מקומות פנויים בחתונה שלהם יוצרים אירוע בפלטפורמה.",
    imageUrl: "/onboarding/slide-4.png",
    imageHint: "event creation",
  },
  {
    title: `${HEBREW_TEXT.general.howItWorks} (2/3)`,
    description: "אורחים מגלים: \nאורחים פוטנציאליים מחפשים  אירועים לפי העדפותיהם.",
    imageUrl: "/onboarding/slide-5.png",
    imageHint: "event discovery",
  },
  {
    title: `${HEBREW_TEXT.general.howItWorks} (3/3)`,
    description: "מתחברים:\nאורח שולח בקשה, בעלי האירוע מאשרים במידה ומתחברים לפרופיל האורח.\nאורחים מצטרפים, החגיגה מתחילה וכולם מרוויחים!",
